...
<!-- WhatsApp Icon -->
<a href="https://wa.me/918080858170" target="_blank" rel="noopener noreferrer" class="whatsapp-icon"
    title="Chat on WhatsApp">
    <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
        image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 509 511.514">
        <path fill="#fff"
